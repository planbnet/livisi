...
The versions starting with `0.0.` are still compatible to the old aiolivisi code, while `1.0.0` did introduce lots of breaking changes besides support for more devices and improved connection stability and error handling.
